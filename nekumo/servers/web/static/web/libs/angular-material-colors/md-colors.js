    ...
    .run(['$interpolate', '$document', function($interpolate, $document){
      function buildCssSelectors(selectors) {
    	  var result = selectors.join('');
			...
			var fgDefaultHue = $interpolate(buildCssSelectors(['.md-{{theme}}-theme','.md-{{hue}}','.md-fg']) + ' {' +
                ' color:{{value}}; fill:{{value}};}');
			var bgDefaultHue = $interpolate(buildCssSelectors(['.md-{{theme}}-theme','.md-{{hue}}','.md-bg']) + ' { background-color:{{value}};}');
			var fgColor = $interpolate(buildCssSelectors(['.md-{{theme}}-theme','.md-{{palette}}','.md-fg']) + ' {' +
                ' color:{{value}}; fill:{{value}};}');
			...
			var fgHue = $interpolate(buildCssSelectors(['.md-{{theme}}-theme','.md-{{palette}}.md-{{hue}}','.md-fg']) + ' { color:{{value}}; fill:{{value}};}');
