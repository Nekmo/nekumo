...
PACKAGE_NAME = 'nekumo'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/nekumo/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/nekumo'
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['nekumo', 'web server', 'filemanager', 'dropbox', 'owncloud', 'file sharing']  # Palabras clave
